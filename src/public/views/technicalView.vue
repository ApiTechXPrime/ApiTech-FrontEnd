      ...
      <div class="flex">
        ...
        <div>
          ...
          <div class="flex flex-column align-items-center" style="width:500px">
            ...
            <br><br><br>
            <button @click="viewTechnical" style="background-color: #007bff; width: 60%; height: 10%; font-size: 27px; cursor: pointer; border: 5px solid deepskyblue; border-radius: 10px; font-weight: bold;">
              View
            </button>
          </div>
          <!-- edición del perfil -->
...
export default {
  ...
  methods: {
    ...
    viewTechnical() {
      this.$router.push({ name: 'technicalView' });
    },
